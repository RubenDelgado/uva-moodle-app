...
export class CoreConfigConstants {
    ...
    static customurlscheme = 'uva-moodle-app';
    static siteurl = 'uva.eastus2.cloudapp.azure.com';
    static sitename = '';
    ...
    static appstores: any = {
        android: 'com.universidad.virtual.autosur',
        ios: 'id633359593',
        windows: 'moodle-desktop/9p9bwvhdc8c8',
        mac: 'id1255924440',
        linux: 'https://download.moodle.org/desktop/download.php?platform=linux&arch=64',
    };
    static compilationtime = 1634789023106;
    static lastcommit = '5eccf86e19e59647d743137149ba0c51ece1facc';
}
